...
var category = {OBJ: $("#_JD_ALLSORT"),
		...
		//URL_Serv: "http://localhost:8082/rest/itemcat/all?callback=category.getDataService",
		URL_Serv: "http://localhost:8082/rest/itemcat/list?callback=category.getDataService",
