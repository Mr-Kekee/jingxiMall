 ...
 * Generated at: 2017-11-28 13:01:28 UTC
...
public final class item_002dadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t            </td>\r\n");
      out.write("\t        </tr>\r\n");
      out.write("\t        <tr class=\"params_tr hide\">\r\n");
      ...
      out.write("</div>\r\n");
      out.write(" \r\n");
      out.write("<div class=\"hide param_div\">\r\n");
      out.write("\t<ul class=\"param_div_ul\">\r\n");
      out.write("\t\t<li class=\"groups_name\"><label></label></li>\r\n");
      out.write("\t\t<li >\r\n");
      out.write("\t\t\t<ul>\r\n");
      out.write("\t\t\t\t<li class=\"params_name\">\r\n");
      out.write("\t\t\t\t\t<span>|----</span>\r\n");
      out.write("\t\t\t\t\t<label></label>\r\n");
      out.write("\t\t\t\t\t<input name=\"param_input\" style=\"width:98px;\">\r\n");
      out.write("\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t<!-- 接下一个参数项 -->\r\n");
      out.write("\t\t\t</ul>\r\n");
      out.write("\t\t</li>\r\n");
      ...
      out.write("\t$(function(){\r\n");
      out.write("\t\t//创建富文本编辑器\r\n");
      out.write("\t\titemAddEditor = JINGXI.createEditor(\"#itemAddForm [name=desc]\");\r\n");
      out.write("\t\t//初始化类目选择和图片上传器\r\n");
      out.write("\t\tJINGXI.init({fun:function(node){\r\n");
      out.write("\t\t\t//根据商品的分类id取商品 的规格模板，生成规格信息。\r\n");
      out.write("\t\t\t//JINGXI.changeItemParam(node, \"itemAddForm\");\r\n");
      out.write("\t\t}});\r\n");
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("\t//提交表单\r\n");
      ...
      out.write("\t\t$(\"#itemAddForm .param_div_ul\").each(function(i,e){\r\n");
      out.write("\t\t\tvar group = $(e).find(\"li\").eq(0).find(\"label\").text();\r\n");
      out.write("\t\t\tvar param_lis = $(e).find(\"li\").eq(1).find(\"li\");\r\n");
      out.write("\t\t\tvar ps = [];\r\n");
      out.write("\t\t\tfor(var i=0;i<param_lis.length;i++){\r\n");
      out.write("\t\t\t\tvar param_li = param_lis.eq(i);\r\n");
      out.write("\t\t\t\tvar param_name = param_li.find(\"label\").text();\r\n");
      out.write("\t\t\t\tvar param_val = param_li.find(\"input\").val();\r\n");
      out.write("\t\t\t\t//加判断再添加\r\n");
      out.write("\t\t\t\tif(param_val!=\"\"){\r\n");
      out.write("\t\t\t\t\tps.push({\r\n");
      out.write("\t\t\t\t\t\t\"k\" : $.trim(param_name),\r\n");
      out.write("\t\t\t\t\t\t\"v\" : $.trim(param_val)\r\n");
      out.write("\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tif(ps.length!=0){\r\n");
